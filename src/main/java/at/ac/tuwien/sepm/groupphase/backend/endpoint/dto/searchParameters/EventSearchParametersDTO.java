...
public class EventSearchParametersDTO {
    ...
    public EventSearchParametersDTO(String name, Integer durationInMinutes, String content, String description, EventType eventType, String locationName) {
        this.name = name;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(name, durationInMinutes, content, description, eventType, locationName);
    }
    ...
    public static class EventSearchParametersDTOBuilder {
        ...
        public EventSearchParametersDTO build() {
            return new EventSearchParametersDTO(name, durationInMinutes, content, description, eventType, locationName);
        }
    }
}
