...
public interface EventService {
     ...
     */
    //List<EventDTO> findTopTenEvents(Set<String> monthsSet, Set<EventType> categoriesSet) throws ServiceException;
    ...
    /**
     * Find all events filtered by eventName, eventType, content, description, duration
     *
     * @param parameters object containing eventName, eventType, content, description, duration
     * @param page the number of the specific requested page
